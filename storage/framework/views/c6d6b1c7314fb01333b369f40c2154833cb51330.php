...
<?php $__env->startSection('content'); ?>
	<div class="card">
		...
		<div class="card-body">
			<form action="<?php echo e(url('/baiviet/them')); ?>" method="post" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="tieude" name="tieude" />
...
unset($__errorArgs, $__bag); ?>" id="noidung" name="noidung" rows="10" cols="50"></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Wamp\www\qlsv_v4.0\resources\views/baiviet/them.blade.php ENDPATH**/ ?>