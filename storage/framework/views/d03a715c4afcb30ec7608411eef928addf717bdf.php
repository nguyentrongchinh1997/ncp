	...
	<div class="card">
		...
		<div class="card-body">
			<p>
				...
				<a href="#" class="btn btn-success" data-toggle="modal" data-target="#exampleModal" ><i class="fal fa-upload"></i> Nhập từ Excel</a>
			...
			<table class="table table-bordered table-sm">
				<thead>
					<tr>
						...
						<th>Điện thoại</th>
						<th>Email</th>
						<th>Tên miền đã thuê</th>
						<th>Hosting đã thuê</th>
						<th>Ghi chú</th>
						<th>Sửa</th>
						<th>Xóa</th>
					</tr>
				...
				<tbody>
					<?php $__currentLoopData = $khachhang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							...
							<td><?php echo e($value->Domain->tendomain); ?></td>
							<td><?php echo e($value->Hosting->diachiip); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Wamp\www\qlsv_v4.0\resources\views/khachhang/danhsach.blade.php ENDPATH**/ ?>