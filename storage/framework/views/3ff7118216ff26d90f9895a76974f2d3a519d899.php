...
<div>
    <div class="card">
		...
		<div class="card-body">
			<form action="<?php echo e(url('/sanpham/giohang')); ?>" method="post">
				<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
				...
				<div class="form-group">
					<label for="loaihosting">Điện thoại</label>
...
unset($__errorArgs, $__bag); ?>" id="loaihosting" name="loaihosting">
			...
			<?php if(Session::has('success')): ?>
	            <div class="alert alert-success">
	                ...
	                <a class="btn btn-primary" href="/sanphamhosting">Quay lại</a>
	            </div>
        	<?php endif; ?>
		</div>
	</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Wamp\www\resources\views//sanpham/regishosting.blade.php ENDPATH**/ ?>