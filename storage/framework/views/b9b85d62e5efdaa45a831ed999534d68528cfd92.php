...
unset($__errorArgs, $__bag); ?>
				...
				<div class="form-group">
					...
					<select class="form-control <?php $__errorArgs = ['thoihan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="thoihan" name="thoihan">
						<option value=""><?php echo e($domain->thoihan); ?></option>
							<option>1 năm</option>
							<option>2 năm</option>
							<option>3 năm</option>
					</select>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Wamp\www\resources\views/domain/sua.blade.php ENDPATH**/ ?>