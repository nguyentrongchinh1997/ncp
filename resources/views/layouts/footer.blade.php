          ...
          <div class="container">
            <div class="row">
                ...
                <div class="">
                      <ul class="">
                        <a href="https://www.facebook.com/htnghia.dh18pm/">
                            <img class="logo-footer" src="{{ asset('/images/icon/facebook.svg') }}" width="10%" height="10%" />
                        </a>
                        <a>
                            <img class="logo-footer" src="{{ asset('/images/icon/youtube.svg') }}" width="10%" height="10%" />
                        </a>
                        <a>
                            <img class="logo-footer" src="{{ asset('/images/icon/twitter.svg') }}" width="10%" height="10%" />
                        </a>
                        <a>
                            <img class="logo-footer" src="{{ asset('/images/icon/ins.svg') }}" width="10%" height="10%" />
                        </a>
                      </ul>
                </div>
              </div>
              <div class="col-6 col-md-4">
                ...
                <form class="">
                    <div class="list-us">
                        <img class="logo-footer" src="{{ asset('/images/icon/adress.svg') }}" width="10%" height="10%" />
                        <a class="text-footer" href="#">Long Xuyên, An Giang</a>
                    </div>
                    <div class="list-us">
                        <img class="logo-footer" src="{{ asset('/images/icon/phone.svg') }}" width="10%" height="10%" />
                        <a class="text-footer" href="tel:0332691871">Hotline: 0332691871</a>
                    </div>
                    <div class="list-us">
                        <img class="logo-footer" src="{{ asset('/images/icon/email.svg') }}" width="10%" height="10%" />
                        <a class="text-footer" href="mailto:trongnghia.cl.tb.ag@gmail.com">Email: leo.angel.tb@gmail.com</a>
                    </div>
                    <div class="list-us">
                        <img class="logo-footer" src="{{ asset('/images/icon/form.svg') }}" width="10%" height="10%" />
                        <a class="text-footer" href="{{route('contact')}}">Form liên hệ</a>
                    </div>
                </form>
              </div>
              <div class="col-6 col-md-4">
                ...
                <ul>
                    ...
                    <img class="logo-footer" src="{{ asset('/images/icon/bct.svg') }}" width="100%" height="100%" />
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="container">
            <div class="row row-10 align-items-center justify-content-sm-between">
              <div class="col-md-auto">
                <p class="rights"><span>Copy right {{ date('Y') }} &copy;&nbsp;</span><span class="copyright-year"></span><span>&nbsp;</span><span>{{ config('app.name', 'Laravel') }}</span><span>.&nbsp; All rights reserved</span></p>
              </div>
              <div class="col-md-auto order-md-1">Hosted by <a target="_blank"
                href="https://giayphut.com">Giayphut.com</a></div>
              <div class="col-md-auto">
                    Power by <a href="">{{ config('app.name') }}</a>
              </div>
            </div>
