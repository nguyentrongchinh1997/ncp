...
<div class="container bg-img">
    <div class="row">
        <div class="col-md-3 col-sm-6" onclick="window.open('{{route('sanphamdomain')}}','mywindow');">
            <div class="box">
        ...
        <div class="col-md-3 col-sm-6" onclick="window.open('{{route('sanphamhosting')}}','mywindow');">
            <div class="box">
        ...
        <div class="col-md-3 col-sm-6" onclick="window.open('{{route('contact')}}','mywindow');">
            <div class="box">
        ...
        <div class="col-md-3 col-sm-6" onclick="window.open('{{route('baiviet')}}','mywindow');">
            <div class="box">
                      ...
                      <div class="card-body">
                        ...
                        <div class="row mt-4 form-group mb-0">
                            <div class="col-md-4 col-sm-6 all-center">
                                <img src="{{ asset('/images/icon/facebook.svg') }}" width="30%" />
                            </div>
                            <div class="col-md-4 col-sm-6 all-center">
                                <img src="{{ asset('/images/icon/twitter.svg') }}" width="30%"/>
                            </div>
                            <div class="col-md-4 col-sm-6 all-center">
                                <img src="{{ asset('/images/icon/ins.svg') }}" width="30%"/>
                            </div>
                        </div>
